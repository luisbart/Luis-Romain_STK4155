...
dnn = MLPClassifier(hidden_layer_sizes=1, activation='relu', solver ='lbfgs',alpha=1.e-2, learning_rate_init=1.e-7, max_iter=100000, random_state=1)
...
# Logistic Regression
logreg = LogisticRegression(solver='lbfgs', max_iter=10000, C=10, random_state=1)
...
# Decision Trees
deep_tree_clf = DecisionTreeClassifier(max_depth=4, criterion="entropy", random_state=1)
...
svm = SVC(gamma='scale', C=1, random_state=1)
...
Random_Forest_model = RandomForestClassifier(n_estimators=40, max_depth=4, criterion="gini", random_state=5)
...
fig = skplt.metrics.plot_confusion_matrix(y_test, y_pred, normalize=False)
fig.plot()
fig.set_title("MLP")
...
fig2 = skplt.metrics.plot_confusion_matrix(y_test, y_pred2, normalize=False)
fig2.plot()
fig2.set_title("SVM")
...
fig3 =skplt.metrics.plot_confusion_matrix(y_test, y_pred3, normalize=False)
fig3.plot()
...
fig4 = skplt.metrics.plot_confusion_matrix(y_test, y_pred4, normalize=False)
fig4.plot()
fig4.set_title("DT")
