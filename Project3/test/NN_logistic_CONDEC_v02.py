...
plt.savefig(f"Results/NN/NN_TrainingAccuracy_logistic_CON_DEC_.png", dpi=150)
plt.show()
...
ax.set_ylabel("$\eta$")
ax.set_xlabel("$\lambda$")
plt.savefig(f"Results/NN/NN_TestAccuracy_logistic_CON_DEC_.png", dpi=150)
plt.show()

        
#%%
#Choose the right eta and lambda
eta_val = np.logspace(-8, -8, 1)
lmbd_val = np.logspace(1, 1, 1)
...
plt.savefig(f"Results/NN/NN_Conf_Matrix_logistic_CON_DEC_.png", dpi=150)
plt.show()        
