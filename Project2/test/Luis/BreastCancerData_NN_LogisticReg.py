...
heat5.set(xlabel='learning rate', ylabel ='regularization', title = f"Accuracy score training set")
plt.savefig(f"Results/NN/BreastCancer_Logistic_regression_train_keras_l2.png", dpi=150)
plt.show()
...
heat5.set(xlabel='learning rate', ylabel ='regularization', title = f"Accuracy score test set")
plt.savefig(f"Results/NN/BreastCancer_Logistic_regression_test_keras_l2.png", dpi=150)
plt.show()
